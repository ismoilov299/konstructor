...
from modul.clientbot.handlers.leomatch.shortcuts import bot_show_profile_db, clear_all_likes, delete_like, get_leo, get_leos_id, get_first_like, leo_set_like, show_media, show_profile_db
from modul.clientbot.handlers.leomatch.keyboards.inline_kb import profile_alert, profile_alert_action, profile_like_action, profile_view_action, write_profile
...
@client_bot_router.message(StateFilter(LeomatchProfiles.INPUT_MESSAGE))
async def bot_start(message: types.Message, state: FSMContext):
    data = await state.get_data()
